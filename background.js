...
chrome.contextMenus.onClicked.addListener((info, tab) => {
    ...
    switch (info.menuItemId) {
        ...
        case "Malware Bazaar":
            urls.push("https://bazaar.abuse.ch/browse/");
            if (!fallthrough) { break; }

        case "TrendMicro":
            urls.push("https://www.trendmicro.com/vinfo/us/threat-encyclopedia/");
            if (!fallthrough) { break; }

        case "ZoomEye":
            urls.push("https://www.zoomeye.org/searchResult?q=title%3A" + artifact);
            if (!fallthrough) { break; }
